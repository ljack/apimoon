...
import {TableColumns, ColumnMeta,FormOptions,SaveCollection,DeleteObject} from '/client/apimoon-columns.jsx';
...
export const ApimoonsPage = React.createClass({
		mixins: [
		ReactMeteorData
	],
	...
	<div className="page-container container" id="content">
		...
		<ApimoonsPageView data={this.data} />
	</div>
);
		}
	}
...
export const ApimoonsPageView = React.createClass({
	componentWillReceiveProps(nextProps) {
		console.log("ApimoonsPageView componentWillReceiveProps,nextProps=",nextProps);	
	},
	...
	<Modal ref="modal" style={CustomStyle} isOpen={this.state.modalIsOpen}>
		...
		render() {
			...
			return (
	<div id="apimoons-page-view" className="" template="ApimoonsPageView">
...
*/
		...
		exportCsv(event, data, abba) {
			...
			this.exportData(Apimoons, "csv");
			return false;
		}, exportTsv() {
			this.exportData(Apimoons, "tsv");
		},
		exportJson() {
			this.exportData(Apimoons, "json");
		},
		render() {
			return (
