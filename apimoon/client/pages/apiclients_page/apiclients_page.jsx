...
import {TableColumns, ColumnMeta,FormOptions,SaveCollection} from '/lib/collections/apiclient-columns.jsx';
...
export const ApiclientsPage = React.createClass({
		mixins: [
		ReactMeteorData
	],
	...
	getMeteorData: function() {
		...
		if(this.isReady()) {
			...
			data = {
				...
				apiclients: Apiclients.find({}, {}).fetch()
			};
	...
	<div className="page-container container" id="content">
		...
		<ApiclientsPageView data={this.data} />
	</div>
);
		}
	}
...
export const ApiclientsPageView = React.createClass({
	componentWillReceiveProps(nextProps) {
		console.log("ApiclientsPageView componentWillReceiveProps,nextProps=",nextProps);	
	},
	...
	<Modal ref="modal" style={CustomStyle} isOpen={this.state.modalIsOpen}>
		...
		render() {
			...
			return (
	<div id="apiclients-page-view" className="" template="ApiclientsPageView">
...
*/
		...
		exportCsv(event, data, abba) {
			...
			this.exportData(Apiclients, "csv");
			return false;
		}, exportTsv() {
			this.exportData(Apiclients, "tsv");
		},
		exportJson() {
			this.exportData(Apiclients, "json");
		},
		render() {
			return (
