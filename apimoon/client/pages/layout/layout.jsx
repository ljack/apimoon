...
export const PrivateLayout = React.createClass({
	...
	<div>
		...
		<div id="footer" className="sticky-footer">
			<div className="footer-container container">
				<p className="text-muted">
					Check source code at GitHub: <a href="https://github.com/ljack/apimoon">https://github.com/ljack/apimoon</a> and <a href="https://github.com/ljack/kitchen-templates/">https://github.com/ljack/kitchen-templates/</a>
				</p>
			</div>
		</div>
	</div>
...
export const PrivateLayoutLeftMenu = React.createClass({
	...
	<ul id="menu-items" className="nav navbar-nav">
		...
		<li id="menu-item-simple" className={menuItemClass('apiclients_page')}>
			<a href={pathFor('apiclients_page')}>
				<span className="item-title">
					Apiclients
				</span>
			</a>
